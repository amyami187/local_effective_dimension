...
for j in range(10):
    convnet = ClassicalNeuralNetwork(size=[crop*crop*3, 900, 900, 10]).to('cpu')
...
np.save('ed_norm_cifar3m.npy', effdim_norm)
np.save('train_error_cifar3m.npy', train_error)
np.save('test_error_cifar3m.npy', test_error)
