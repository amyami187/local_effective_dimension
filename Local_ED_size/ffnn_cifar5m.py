...
for j in range(10):
    convnet = ClassicalNeuralNetwork(size=[crop*crop*3, 1500, 1500, 10]).to('cpu')
...
np.save('ed_norm_cifar5m.npy', effdim_norm)
np.save('train_error_cifar5m.npy', train_error)
np.save('test_error_cifar5m.npy', test_error)
