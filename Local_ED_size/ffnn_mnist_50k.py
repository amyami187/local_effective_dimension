...
for j in range(10):
    convnet = ClassicalNeuralNetwork(size=[28*28, 60, 60, 10]).to('cpu')
...
np.save('ed_norm50k.npy', effdim_norm)
np.save('train_error50k.npy', train_error)
np.save('test_error50k.npy', test_error)
