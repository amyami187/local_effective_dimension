...
for j in range(10):
    convnet = ClassicalNeuralNetwork(size=[crop*crop*3, 1900, 1900, 10]).to('cpu')
...
np.save('ed_norm_cifar8m.npy', effdim_norm)
np.save('train_error_cifar8m.npy', train_error)
np.save('test_error_cifar8m.npy', test_error)
