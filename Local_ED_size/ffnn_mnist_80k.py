...
for j in range(10):
    convnet = ClassicalNeuralNetwork(size=[28*28, 90, 90, 10]).to('cpu')
...
np.save('ed_norm80k.npy', effdim_norm)
np.save('train_error80k.npy', train_error)
np.save('test_error80k.npy', test_error)
