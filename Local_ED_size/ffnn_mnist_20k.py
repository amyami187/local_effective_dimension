...
for j in range(10):
    convnet = ClassicalNeuralNetwork(size=[28*28, 30, 30, 10]).to('cpu')
...
np.save('ed_norm20k.npy', effdim_norm)
np.save('train_error20k.npy', train_error)
np.save('test_error20k.npy', test_error)
