...
for j in range(10):
    convnet = ClassicalNeuralNetwork(size=[crop*crop*3, 400, 300, 10]).to('cpu')
...
np.save('ed_norm_cifar1m.npy', effdim_norm)
np.save('train_error_cifar1m.npy', train_error)
np.save('test_error_cifar1m.npy', test_error)
