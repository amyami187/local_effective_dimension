...
for j in range(10):
    convnet = ClassicalNeuralNetwork(size=[crop*crop*3, 200, 200, 10]).to('cpu')
...
np.save('ed_norm_cifar500k.npy', effdim_norm)
np.save('train_error_cifar500k.npy', train_error)
np.save('test_error_cifar500k.npy', test_error)
